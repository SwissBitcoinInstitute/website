            ...
            <div className="card-general card-gradient-hover mb-8 overflow-hidden">
              <div className="grid md:grid-cols-2 gap-0">
                <div className="aspect-video bg-black">
                  <iframe
                    className="w-full h-full"
                    src="https://www.youtube.com/embed/L4k_bnBCcgw"
                    title="Bitcoin zwischen Freiheit, Regulierung und digitalem Euro"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                  ></iframe>
                </div>
                <div className="p-8 flex flex-col">
                  <div className="mb-4">
                    ...
                    <h3 className="text-2xl font-semibold mb-4 text-gray-900">
                      Bitcoin zwischen Freiheit, Regulierung und digitalem Euro
                    </h3>
                    <p className="swiss-prose text-gray-700 leading-relaxed mb-6">
                      Prof. Dr. Gunther Schnabl und Dr. Marcus Dapp diskutieren Bitcoin als freiheitliche Alternative zum Fiatgeldsystem. Die Experten analysieren Volatilität, staatliche Regulierung in der Schweiz und EU sowie den digitalen Euro. Erfahren Sie, warum Bitcoin mehr als nur Spekulation ist.
                    </p>
                  </div>
                  <div className="space-y-3 text-sm text-gray-600 mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Podcast Fokus Wirtschaftspolitik, February 2026</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="12" cy="12" r="10"></circle>
        ...
        <div className="swiss-grid relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
              <CTAButton variant="primary" size="lg" href="/inquiry?service=speaking">
                Book a Speaker
              </CTAButton>
            </div>
          </div>
