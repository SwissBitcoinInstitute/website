  ...
  const domains = [
    {
      ...
      icon: "/domain-icons/markets-and-geopolitics.png",
    ...
    },
    {
      ...
      icon: "/domain-icons/finance-and-economics.png",
    ...
    },
    {
      ...
      icon: "/domain-icons/technology-and-innovation.png",
    ...
    },
    {
      ...
      icon: "/domain-icons/energy-and-climate.png",
    ...
    {
      title: "Access & Agency",
      icon: "/domain-icons/access-and-agency.png",
    ...
    },
    {
      ...
      icon: "/domain-icons/strategy-and-policy.png",
          ...
          <div className="max-w-4xl mx-auto space-y-16">
            {domains.map((domain, index) => (
              <article
                key={index}
                id={domain.anchorId}
                className={`relative ${domain.bgColor} rounded-2xl p-8 md:p-12 shadow-sm border border-gray-200/50 scroll-mt-24`}
              >
                ...
                <div className="mb-6 flex flex-col md:flex-row items-start gap-8">
                  {domain.icon && (
                    <div className="shrink-0">
                      <img src={domain.icon} alt={`${domain.title} Icon`} className="w-24 h-24 md:w-32 md:h-32 object-contain drop-shadow-sm" />
                    </div>
                  )}
                  <div>
                    ...
                    <p className="text-xl font-semibold text-gray-700 italic border-l-4 border-gray-300 pl-4">
                      {domain.question}
                    </p>
                  </div>
                </div>
