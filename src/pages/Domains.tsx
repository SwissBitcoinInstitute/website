        ...
        <div className="swiss-grid">
          <div className="max-w-4xl mx-auto space-y-16">
            {domains.map((domain, index) => (
              <article
                key={index}
                className={`relative bg-gradient-to-br ${domain.gradient} rounded-2xl p-8 md:p-12 shadow-sm border border-gray-200/50`}
              >
                ...
                {index < domains.length - 1 && (
                  <div className="mt-12 pt-8 border-t border-gray-300/50">
                    <div className="flex items-center justify-center">
                      <div className="w-1 h-12 bg-gradient-to-b from-gray-300 to-transparent rounded-full"></div>
                    </div>
                  </div>
                )}
              </article>
